import { index, pgTable, text, timestamp, uuid, boolean, jsonb, pgEnum } from 'drizzle-orm/pg-core';
...
export const notifications = pgTable(
  ...
  table => [index('idx_notifications_user_created_at').on(table.userId, table.createdAt.desc())]
);
